      ...
      test(` at sec ${sec}`, () => {
        const animationContext = makeMe
                ...
                .withSubtitle({ leadingBlank: 1, duration: 3, text: 'First subtitle.', actions: [
                  { actor: 'under-test', actionType: 'highlight lines', startDuration: 1, lines: [1, 3, 4] }
                ]})
                .seconds(sec)
                .please();
    ...
    [
      ...
      test(` at sec ${sec}`, () => {
        const animationContext = makeMe
                .animationContext
                .withSubtitle({ leadingBlank: 1, duration: 3, text: 'First subtitle.', actions: [
                  { actor: 'under-test', actionType: 'highlight token', startDuration: 1, token: "isLoad" }
                ]})
                .seconds(sec)
                .please();
        const div = renderAndGetDiv(animationContext);
    ...
    [
      ...
      test(` at sec ${sec}`, () => {
        const animationContext = makeMe
                .animationContext
                .withSubtitle({ leadingBlank: 1, duration: 3, text: 'First subtitle.', actions: [
                  { actor: 'under-test', actionType: 'highlight token', startDuration: 1, token: "isLoad", style: 'wavy underline' }
                ]})
                .seconds(sec)
                .please();
        const div = renderAndGetDiv(animationContext);
    ...
    [
      ...
      test(` at sec ${sec}`, () => {
        const animationContext = makeMe
                .animationContext
                .withSubtitle({ leadingBlank: 1, duration: 3, text: 'First subtitle.', actions: [
                  { actor: 'under-test', actionType: 'highlight lines', startDuration: 1, lines: [1], style: 'wavy underline' }
                ]})
                .seconds(sec)
                .please();
        const div = renderAndGetDiv(animationContext);
    ...
    [
      ...
      test(` at sec ${sec}`, () => {
        const animationContext = makeMe
                .animationContext
                .withSubtitle({ leadingBlank: 1, duration: 3, text: 'First subtitle.', actions: [
                  { actor: 'under-test', actionType: 'replace text', startDuration: 1, line: 2, match: 'isLoad', replacement: 'loadAmount' }
                ]})
                .seconds(sec)
                .please();
        const div = renderAndGetDiv(animationContext);
    ...
    [
      ...
      test(` at sec ${sec}`, () => {
        const animationContext = makeMe
                .animationContext
                .withSubtitle({ leadingBlank: 1, duration: 3, text: 'First subtitle.', actions: [
                  { actor: 'under-test', actionType: 'replace text', startDuration: 1, line: 2, replacement: 'loadAmount' }
                ]})
                .seconds(sec)
                .please();
        const div = renderAndGetDiv(animationContext);
    ...
    [
      ...
      test(` at sec ${sec}`, () => {
        const animationContext = makeMe
                .animationContext
                .withSubtitle({ leadingBlank: 1, duration: 3, text: 'First subtitle.', actions: [
                  { actor: 'under-test', actionType: 'insert text', startDuration: 1, line: 4, column: 16, text: 'loadAmount' }
                ]})
                .seconds(sec)
                .please();
        const div = renderAndGetDiv(animationContext);
    ...
    [
      ...
      test(` at sec ${sec}`, () => {
        const animationContext = makeMe
                .animationContext
                .withSubtitle({ leadingBlank: 1, duration: 3, text: 'First subtitle.', actions: [
                  { actor: 'under-test', actionType: 'delete lines', startDuration: 1, fromLine: 2, count: 4 }
                ]})
                .seconds(sec)
                .please();
        const div = renderAndGetDiv(animationContext);
