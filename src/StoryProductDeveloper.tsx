...
const subtitles: Subtitle[] = [
	...
	{ leadingBlank: 0, duration: 4, text: 'or meet their needs.', actions:[
		{ actor: 'happy-mom', actionType: 'glow', startDuration: 2 },
	] },
	...
	{ leadingBlank: 0, duration: 4, text: 'such as money, to fuel growth.', actions:[
		{ actor: 'company', actionType: 'glow', startDuration: 2 },
	] },
	{ leadingBlank: 1, duration: 3, text: 'Software products often play a', actions:[
		{ actor: 'product', actionType: 'rotate and rise', startDuration: 1, value: 4 },
	...
	{ leadingBlank: 1, duration: 3, text: 'Developers were part of external teams,', actions:[
		{ actor: 'stage', actionType: 'scale', startDuration: 1, outputRange: [1, 0.7] },
		{ actor: 'stage', actionType: 'move', startDuration: 1, absolutePosition: [100, 70] },
	] },
