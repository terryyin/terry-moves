...
export const booleanParametersSutitles: Subtitle[] = [
	{
			...
			actions: [
				{ actor: "second title", actionType: "insert text", endingTimeAdjustment: 3, line: 1, column: 1, text: "Seeking High Cohesion, Loose Coupling design", startDurationX: 1, endDurationX: 2 },
...

	{
			...
			actions: [
				...
				{ actor: "a1-param", actionType: "connect to", startDurationX: 1, endingTimeAdjustment: 10, target: "callee-load", bentLevel: 30},
				{ actor: "a2-param", actionType: "connect to",  startDurationX: 1,endingTimeAdjustment: 10, target: "callee-fire", bentLevel: 30},
				{ actor: "a3-param", actionType: "connect to",  startDurationX: 1,endingTimeAdjustment: 10, target: "callee-load", bentLevel: 30},
			],
	},
...

	{
		...
		actions: [
			...
			{ actor: 'caller 3 callout1', actionType: 'disappear', startDuration: 0.5},
				{ actor: "a1-action", actionType: "connect to", startDurationX: 1, endingTimeAdjustment: 6, target: "callee-action", bentLevel: -30},
				{ actor: "a2-action", actionType: "connect to",  startDurationX: 1,endingTimeAdjustment: 6, target: "callee-action", bentLevel: -30},
				{ actor: "a3-action", actionType: "connect to",  startDurationX: 1,endingTimeAdjustment: 6, target: "callee-action", bentLevel: -30},
				{ actor: "a1-param", actionType: "connect to",  startDurationX: 1,endingTimeAdjustment: 6, target: "callee-load", bentLevel: 30},
				{ actor: "a2-param", actionType: "connect to",  startDurationX: 1,endingTimeAdjustment: 6, target: "callee-fire", bentLevel: 30},
				{ actor: "a3-param", actionType: "connect to",  startDurationX: 1,endingTimeAdjustment: 6, target: "callee-load", bentLevel: 30},
		],
	},
...

	{
		...
		translations: {zhCN: "以及松耦合。"},
			actions: [
				{ actor: "a1-action", actionType: "connect to",  startDurationX: 1,endingTimeAdjustment: 20, target: "callee-loadedfire", bentLevel: -30},
				{ actor: "a2-action", actionType: "connect to",  startDurationX: 1,endingTimeAdjustment: 20, target: "callee-action", bentLevel: -30},
				{ actor: "a3-action", actionType: "connect to",  startDurationX: 1,endingTimeAdjustment: 20, target: "callee-loadedfire", bentLevel: -30},
			],
	},
